<div id="Main"
    class="w-32 h-screen xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start  sm:w-64 bg-gray-900 flex-col">
      ...
      {{-- DASHBOARD --}}
        ...
        <button
            ...
            <a href="{{ route('avatar.index') }}">
                <p class="text-base leading-4 ">Avatars</p>
            </a>
        </button>
        ...
        <button
            ...
            <a href="{{ route('categorie.index') }}">
                <p class="text-base leading-4 ">Catégories</p>
            </a>
        </button>
        <button
            class="flex jusitfy-start items-center w-full  space-x-6 focus:outline-none text-white focus:text-indigo-400   rounded ">
        ...
        <button
            ...
            <a href="{{ route('gallerie.index') }}">
                <p class="text-base leading-4 ">Gallerie</p>
            </a>
        </button>
        <button>
        <form action="{{ route('logout') }}" method="POST">
            @csrf
            <button class="text-white">Deconnexion</button>
        </form>
